 ...
 * @author PC
 */
public class ChildrensHome_GUI implements ActionListener
{
    ...
    public void childrensHomeGUI()
    {
        JFrame childFrame = new JFrame();
        //frame properties
        childFrame.setSize(700, 400);
        childFrame.setLocation(new Point(150,150));
        childFrame.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
        childFrame.setTitle("M's Children's Home");
        ...
        //Title
        JLabel childTitle = new JLabel("M's CHILDREN HOME");
        northPanel.add(childTitle);
        ...
        childFrame.add(northPanel, BorderLayout.NORTH);
        childFrame.add(centerPanel, BorderLayout.CENTER);
        childFrame.add(southPanel, BorderLayout.SOUTH);
